            ...
            <div class="card-statistic-3">
                ...
                <div class="card-content">
                    ...
                    <p class="mb-0 text-sm">
                        ...
                        <span class="text-nowrap">Tienes el {{ ($atendidos * 100) / $total }}% de requerimientos atendidos</span>
                        @else
            ...
            <div class="card-statistic-3">
                ...
                <div class="card-content">
                    ...
                    <p class="mb-0 text-sm">
                        ...
                        <span class="text-nowrap">Tienes el {{ ($pendiente * 100) / $total }}% de requerimientos pendientes</span>
                        @else
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td class="text-left"> <a href="{{ route('coordinador.requerimiento.show', $requerimiento->id) }}">Requerimiento {{ $requerimiento->id }}</a></td>
