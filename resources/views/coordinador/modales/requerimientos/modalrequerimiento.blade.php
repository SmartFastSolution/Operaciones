  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content bg-secondary">
      ...
      <div class="modal-footer br">
        @if ($editMode)
        <button type="button" wire:loading.attr="disabled" wire:target="updateRequerimiento" class="btn btn-warning" @if ($createDisabled) disabled="" @endif wire:click="$emit('actualizarObservacion')">Actualizar Requerimiento</button>
        @else
        <button type="button" wire:loading.attr="disabled" wire:target="editRequerimiento" class="btn btn-primary" @if ($createDisabled) disabled="" @endif  wire:click="$emit('guardarObservacion')">Crear Requerimiento</button>
        @endif
      </div>
    </div>
  </div>
