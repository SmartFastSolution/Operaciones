        ...
        <div class="modal-content ">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">
                    @if ($editMode) Actualizar @else Crear @endif
                    Producto
                </h5>
            ...
            <div class="modal-body">
                ...
                @endif
                @if ($editMode && !isset($foto) && isset($picture))
                ...
                <div class="form-row justify-content-center">
                    <div class="form-group col-6">
                        ...
                        <div class="custom-file">
                            <input type="file" wire:model="foto" accept="image/x-png,image/gif,image/jpeg"
                                class="custom-file-input" id="customFile">
                            <label class="custom-file-label" for="customFile">@isset($foto)
                                {{ $foto->getClientOriginalName() }} @endisset</label>
                        </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-lg-4 col-sm-12">
                        ...
                        @error('presentacion_producto') <span class="error text-danger">{{ $message }}</span>
                        @enderror
            ...
            <div class="modal-footer br">
                @if ($editMode)
                    <button type="button" wire:target="updateProducto, crearProducto" wire.loading.attr="disabled"
                        class="btn btn-warning" wire:click="updateProducto">Actualizar Producto</button>
                @else
                    <button type="button" wire:target="updateProducto, crearProducto" wire.loading.attr="disabled"
                        class="btn btn-primary" wire:click="crearProducto">Crear Producto</button>
                @endif
            </div>
        </div>
    </div>
