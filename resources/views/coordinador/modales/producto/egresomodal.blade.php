    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="border p-2">
          ...
          <div class="form-row justify-content-center">
            ...
            <div class="form-group col-lg-2 col-sm-12">
              <input type="number" class="form-control text-right" disabled="" v-model="cantidad_real" min="1" placeholder="Cant">
            </div>
            <div class="form-group col-lg-2 col-sm-12">
      ...
      <div class="modal-footer br">
        <div v-if="!updateMode" class="text-center">
          <a v-if="!creating" href="" class="btn btn-success" @click.prevent="generarEgreso()">Generar Egreso</a>
        ...
        <div v-if="updateMode">
          <a v-if="!updating" href="" class="btn btn-success" @click.prevent="actualizarEgreso()">Actualizar Egreso</a>
          <button v-else class="btn btn-primary" type="button" disabled>
          <span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span>
          Actualizando...
          </button>
