                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown @yield('usuarios')">
                            ...
                            <ul class="dropdown-menu  ">
                                <li><a class="nav-link" href="{{ route('usuario.index') }}">Lista de Usuarios</a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown @yield('sectores')">
                            <a href="#" class="nav-link has-dropdown "><i
                                    class="fas fa-map"></i><span>Sectores</span></a>
                            <ul class="dropdown-menu  ">
                        ...
                        <li class="dropdown @yield('medidas')">
                            <a href="#" class="nav-link has-dropdown "><i
                                    class="fas fa-weight"></i><span>Medidas</span></a>
                            <ul class="dropdown-menu  ">
                                <li><a class="nav-link" href="{{ route('medida.index') }}">Unidades de Medidas</a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown @yield('tipos-registro')">
                            <a href="#" class="nav-link has-dropdown "><i
                                    class="fas fa-clipboard-list"></i><span>Requerimientos</span></a>
                            <ul class="dropdown-menu  ">
                                <li><a class="nav-link"
                                        href="{{ route('tipo-requerimiento.index') }}">Requerimientos</a></li>
                            </ul>
                        </li>
                        @endrole
                        @role('admin')
                        ...
                        <li class="dropdown @yield('requerimiento')">
                            <a href="#" class="nav-link has-dropdown "><i
                                    class="fas fa-clipboard-list"></i><span>Requerimientos</span></a>
                            <ul class="dropdown-menu  ">
                                <li class="@yield('productos')"><a class="nav-link"
                                        href="{{ route('coordinador.requerimiento.index') }}">Requerimientos</a></li>
                                {{-- <li class="@yield('atencion')"><a class="nav-link" href="{{ route('coordinador.producto.ingreso') }}">Atencion Requerimiento</a></li> --}}
                                <li class="@yield('asignacion')"><a class="nav-link"
                                        href="{{ route('coordinador.requerimiento.asignar') }}">Asignar
                                        Requerimientos</a></li>
                                <li class="@yield('ver_mapa')"><a class="nav-link"
                                        href="{{ route('coordinador.mapa') }}">Ver Mapa</a></li>
                                <li class="@yield('calendario')"><a class="nav-link"
                                        href="{{ route('coordinador.calendario') }}">Calendario</a></li>
                            </ul>
                        </li>
                        <li class="dropdown @yield('bodega')">
                            <a href="#" class="nav-link has-dropdown "><i
                                    class="fas fa-store"></i><span>Bodega</span></a>
                            <ul class="dropdown-menu  ">
                                <li class="@yield('productos')"><a class="nav-link"
                                        href="{{ route('coordinador.producto.index') }}">Productos</a></li>
                                <li class="@yield('ingresos')"><a class="nav-link"
                                        href="{{ route('coordinador.producto.ingreso') }}">Ingresos</a></li>
                                <li class="@yield('egresos')"><a class="nav-link"
                                        href="{{ route('coordinador.producto.egreso') }}">Egresos</a></li>
                            </ul>
                        </li>
                        @endrole
                        @role('operador')
            ...
            <div class="main-content">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        @endrole
                        @role('coordinador')
                        <li class="breadcrumb-item"><a href="{{ route('coordinador.index') }}"><i
                                    class="fas fa-tachometer-alt"></i> Inicio</a></li>
                        @endrole
                        @role('operador')
                        <li class="breadcrumb-item"><a href="{{ route('operador.index') }}"><i
                                    class="fas fa-tachometer-alt"></i> Inicio</a></li>
