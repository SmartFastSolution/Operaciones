        ...
        <div class="card author-box">
            <div class="card-body">
                <div class="author-box-center">
                    <img alt="image" src="{{ Avatar::create($ingreso->codigo)->setFontSize(35)->setChars(4) }}"
                ...
                <div>
                    ...
                    <p class="clearfix">
                        ...
                        <span class="float-right badge badge-info">
                            {{ number_format($ingreso->total_ingreso, 3, ',', '.') }}
                        </span>
                    </p>
                </div>
            </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @foreach ($ingreso->productos as $producto)
                                        <tr>
                                            <td class=""><a @isset($producto->deleted_at)
                                                        style="text-decoration: line-through"
                                                    @endisset class="btn-link">{{ $producto->nombre }}</a></td>
                                            <td class="text-center">{{ $producto->pivot->cantidad }}
                                                ({{ $producto->medida->simbolo }})</td>
                                            <td class="text-center">
                                                {{ number_format($producto->pivot->total, 3, ',', '.') }}
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
