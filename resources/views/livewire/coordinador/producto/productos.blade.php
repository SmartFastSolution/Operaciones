				...
				<div class="card-body">
					<div class="row p-2">
						<div class="col-lg-3 col-sm-12 mt-2">
							<input wire:model.debounce.300ms="search" type="text" class="form-control p-2" placeholder="Buscar Productos...">
						</div>
					...
					<div class="table-responsive">
						<table class="table table-striped">
							...
							<tbody class="text-center">
								...
								<tr>
									<td class="" width="200"><figure class="avatar mr-2 avatar-sm">
									...
									<td class="text-center">
										<span class="badge  @if ($producto->stock < 10)
											badge-danger
									...
									<td class="text-center"><a href="{{ route('coordinador.producto.show', $producto->id) }}" class="btn btn-primary"><i class="fa fa-eye"></i></a></td>
