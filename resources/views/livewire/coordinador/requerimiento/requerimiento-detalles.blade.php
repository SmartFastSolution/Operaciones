			...
			<div class="card-body">
				...
				<div class="text-center">
					<div class="author-box-description">
						<p>
							<a href="{{ route('coordinador.requerimiento.atencion', $requerimiento->id) }}" class="btn btn-warning"><i class="fa fa-arrow-up"></i> Atender Requerimiento</a>
			...
			<div class="card-body">
				<div >
					...
					<p class="clearfix">
						...
						<span class="float-right text-capitalize badge @if ($requerimiento->estado == 'pendiente')
							badge-danger
	...
	<div class="col-12 col-md-12 col-lg-12">
		<div class="card">
			<div class="padding-20">
				...
				<div class="m-1">
					<a href="{{ route('coordinador.requerimiento.edit',['id'=> $requerimiento->id, 'atencion' =>  $requerimiento->atencion->id]) }}" class="btn btn-warning mr-2">Editar Atencion</a>
					<a href="" class="btn btn-danger" wire:click.prevent="$emit('eliminarRegistro','Seguro que deseas eliminar la atencion?','eliminarAtencion', {{ $requerimiento->atencion->id }})">Eliminar Atención</a>
				</div>
				<ul  class="nav nav-tabs" id="myTab4" role="tablist">
					<li class="nav-item">
					...
					<li class="nav-item">
						<a wire:ignore class="nav-link" id="egreso-tab2" data-toggle="tab" href="#egreso" role="tab" aria-selected="true">Egreso</a>
					</li>
				</ul>
				<div class="tab-content tab-bordered" id="myTab3Content">
					...
					<div class="tab-pane fade " id="atencion-geolocalizacion" role="tabpanel" aria-labelledby="atencion-geolocalizacion-tab2" wire:ignore.self>
						<h3 class="text-center font-weight-bold text-danger">Distancia: <strong> @if ($distancia < 1)
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{ $documento->extension }}</td>
									<td width="25"><a target="_blank" href="{{ $documento->archivo }}" class="btn btn-primary"><i class="fa fa-download"></i></a></td>
									<td width="25"><a href="" class="btn btn-danger" wire:click.prevent="$emit('eliminarRegistro','Seguro que deseas eliminar este Archivo?','deleteDocumento', {{ $documento->id }})" ><i class="fa fa-trash"></i></a></td>
								</tr>
								@endforeach
							</tbody>
						</table>
					</div>
					<div class="tab-pane fade" id="egreso" role="tabpanel" aria-labelledby="egreso-tab2" wire:ignore.self>
						...
						@isset ($requerimiento->atencion->egreso)
							...
							<div class="col-lg-6 col-sm-12">
								...
								<div class="form-row">
									<div class="form-group col-lg-6 col-sm-12">
										<label>Codigo</label>
										<input type="text" class="form-control"  disabled="" value="{{ $requerimiento->atencion->egreso->codigo }}">
									</div>
										<div class="form-group col-lg-6 col-sm-12">
										<label>Total</label>
										<input type="text" class="form-control" disabled=""  value="{{ $requerimiento->atencion->egreso->total_egreso }}">
									</div>
										<div class="form-group col-lg-12 col-sm-12">
										<label>Descripción</label>
										<textarea name="" class="form-control"  disabled="" id="" cols="30" rows="10">{{ $requerimiento->atencion->egreso->descripcion  }}</textarea>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-12">
