<div>
	...
	<button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#createRequerimiento" ><i class="fas fa-clipboard-list"></i>
	Crear Requerimiento
	</button>
	<button type="button" class="btn btn-warning mb-2" data-toggle="modal" data-target="#importarRequerimiento" ><i class="fas fa-file-excel"></i>
	Importar
	</button>
	@if ($exporting)
  ...
  Exportando...
		...
		@else
		<button type="button" class="btn btn-success mb-2" wire:click.prevent="exportarExcel"><i class="fas fa-file-excel"></i>
	Exportar
	</button>
	@endif
						...
						<table class="table table-striped">
							...
							<tbody class="text-center">
								...
								<tr>
									...
									<td class="text-center">{{ Carbon\Carbon::parse($requerimiento->fecha_maxima)->formatLocalized('%d de %B %Y ')}}</td>
									...
									<td class="p-0 text-center">
										<span class="badge @if ($requerimiento->estado == 'ejecutado')
											badge-success
									...
									<td class="p-0 text-center" width="50">
										<a class="btn btn-primary text-dark" href="{{ route('coordinador.requerimiento.show', $requerimiento->id) }}">
											<i class="fa fa-eye"></i>
										</a>
									</td>
									<td class="p-0 text-center" width="50">
										<a class="btn btn-warning text-dark" data-toggle="modal" data-target="#createRequerimiento" wire:click.prevent="editRequerimiento({{ $requerimiento->id }})">
