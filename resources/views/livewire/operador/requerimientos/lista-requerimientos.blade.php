<div class="container-fluid">
    <h3 class=" font-weight-bold text-danger"> N° Requerimientos: <span class="text-dark">{{ $conteo }}</span>
    </h3>
    <div class="row">
        ...
        <div class="col-lg-12 mt-2" id="mapa" wire:ignore>
            ...
            <gmap-map {{-- map-type-id="terrain" --}} :center="center" :zoom="13" style="width:100%;  height: 650px;">

                {{-- <gmap-info-window :options="infoOptions" :position="infoWindowPos" :opened="infoWinOpen" @closeclick="infoWinOpen=false">
                </gmap-info-window> --}}
                <gmap-marker :key="index" v-for="(m, index) in markers" :position="m.position" {{-- @click="center=m.position" --}}
                    :icon="m.img" :clickable="true" @click="cargarRequerimiento(m.requerimiento_id,index)">
                </gmap-marker>
            </gmap-map>
        </div>
    </div>
