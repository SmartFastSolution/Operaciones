<div>
	...
	<button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#createMedida" ><i class="fa fa-plus"></i>
				...
				<div class="card-body p-0">
					<div class="row p-2">
						<div class="col-lg-3 col-sm-12 mt-2">
							<input wire:model.debounce.300ms="search" type="text" class="form-control p-2" placeholder="Buscar Unidad de Medida...">
						</div>
						...
						<table class="table table-striped">
							...
							<tbody class="text-center">
								...
								<tr>
									...
									<td class="p-0 text-center"><span class="badge-warning badge">{{ $medida->simbolo }}</span></td>
									<td class="p-0 text-left">{{ $medida->descripcion }}</td>
									<td class="p-0 text-center">
										<span style="cursor: pointer;" wire:click.prevent="estadochange('{{ $medida->id  }}')" class="badge @if ($medida->estado == 'on')
											badge-success
											@else
											badge-danger
									...
									<td class="p-0 text-center" width="50">
										<a class="btn btn-danger text-dark" wire:click.prevent="$emit('eliminarRegistro','Seguro que deseas eliminar esta Unidad de Medida?','eliminarMedida', {{ $medida->id }})" >
